        ...
        <Navbar />
            <Container>
                <center>
                    ...
                    <h2>Class {name}</h2>
                    <VersionSelector packageName={String(packageName)} versions={versions} includeAdditionalURL={true} additionalURL={`/class/${name}`}/>
                    <br />
            ...
            <Grid columns={[1, null, 2]}>
                ...
                <Container>
                            ...
                            <details key={property.name}>
                                ...
                                <table border={1}>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>abstract</td>
                                            <td>{String(property.abstract)}</td>
                                        </tr>
                                        <tr>
                                            <td>static</td>
                                            <td>{String(property.static)}</td>
                                        </tr>
                                        <tr>
                                            <td>readonly</td>
                                            <td>{String(property.readonly)}</td>
                                        </tr>
                                        <tr>
                                            <td>optional</td>
                                            <td>{String(property.optional)}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </details>
                    ...
                    <hr />
                    <h4>Methods</h4>
                    {element.methods.map((property: any) => {
                        return (
                            <details key={property.name}>
                                <summary>{property.name}</summary>
                                <p>
                                ...
                                returns: {property.signatures[0].returnType.name}
                            </details>
                        )
                    })}
                </Container>
