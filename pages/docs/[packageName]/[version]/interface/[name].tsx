        ...
        <Navbar />
            <Container>
                <center>
                    ...
                    <VersionSelector packageName={String(packageName)} versions={versions} includeAdditionalURL={true} additionalURL={`/interface/${name}`}/>
                    <br />
                        ...
                        return (
                            <details key={property.name}>
                                ...
                                <p>
                                    ...
                                    <br />
                                    readOnly: {String(property.readonly)}
                                    <br />
                                    optional: {String(property.optional)}
                                </p>
                            </details>
                        )
                    })}
...
export async function getStaticPaths() {
    const type = "interfaces" // The type of element this page does
    const paths: any[] = []
