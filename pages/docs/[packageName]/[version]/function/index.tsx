        ...
        <>
            ...
            <Container>
                <center>
                    ...
                    <VersionSelector packageName={String(packageName)} versions={versions} includeAdditionalURL additionalURL="function"/>
                    <br />
            ...
            <Container>
                ...
                <ul>
                    {element.map((child: any) => {
                        return (
                            <li key={child.name}>
                                <a href={`/docs/${packageName}/${version}/function/${child.name}`}>{child.name}</a>
                            </li>
                        )
                    })}
                </ul>
